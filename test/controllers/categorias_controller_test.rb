...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference("Categoria.count") do
      post categorias_url, params: { categoria: { description: @categoria.description, name: @categoria.name } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { description: @categoria.description, name: @categoria.name } }
